...
const ScanSettings$json = const {
  ...
  '2': const [
    ...
    const {'1': 'filter_device_names', '3': 4, '4': 3, '5': 9, '10': 'filterDeviceNames'},
    const {'1': 'filter_mac_addresses', '3': 5, '4': 3, '5': 9, '10': 'filterMacAddresses'},
  ],
};

/// Descriptor for `ScanSettings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scanSettingsDescriptor = $convert.base64Decode('');
...
const ScanResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'errorCodeIfError', '3': 4, '4': 1, '5': 5, '10': 'errorCodeIfError'},
  ],
};

/// Descriptor for `ScanResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scanResultDescriptor = $convert.base64Decode('CgpTY2FuUmVzdWx0EigKBmRldmljZRgBIAEoCzIQLkJsdWV0b290aERldmljZVIGZGV2aWNlEkEKEmFkdmVydGlzZW1lbnRfZGF0YRgCIAEoCzISLkFkdmVydGlzZW1lbnREYXRhUhFhZHZlcnRpc2VtZW50RGF0YRISCgRyc3NpGAMgASgFUgRyc3NpEioKEGVycm9yQ29kZUlmRXJyb3IYBCABKAVSEGVycm9yQ29kZUlmRXJyb3I=');
