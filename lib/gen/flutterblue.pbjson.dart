...
const ScanSettings$json = const {
  ...
  '2': const [
    ...
    const {'1': 'filter_device_name', '3': 4, '4': 1, '5': 9, '10': 'filterDeviceName'},
  ],
};

/// Descriptor for `ScanSettings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scanSettingsDescriptor = $convert.base64Decode('CgxTY2FuU2V0dGluZ3MSKgoRYW5kcm9pZF9zY2FuX21vZGUYASABKAVSD2FuZHJvaWRTY2FuTW9kZRIjCg1zZXJ2aWNlX3V1aWRzGAIgAygJUgxzZXJ2aWNlVXVpZHMSKQoQYWxsb3dfZHVwbGljYXRlcxgDIAEoCFIPYWxsb3dEdXBsaWNhdGVzEiwKEmZpbHRlcl9kZXZpY2VfbmFtZRgEIAEoCVIQZmlsdGVyRGV2aWNlTmFtZQ==');
