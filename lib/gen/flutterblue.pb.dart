...
class ScanSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanSettings', createEmptyInstance: create)
    ...
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filterMacAddresses')
    ..hasRequiredFields = false
  ;
  ...
  factory ScanSettings({
    ...
    $core.Iterable<$core.String>? filterMacAddresses,
  }) {
    final _result = create();
    ...
    if (filterMacAddresses != null) {
      _result.filterMacAddresses.addAll(filterMacAddresses);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(5)
  $core.List<$core.String> get filterMacAddresses => $_getList(4);
}
...
class ScanResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanResult', createEmptyInstance: create)
    ...
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorCodeIfError', $pb.PbFieldType.O3, protoName: 'errorCodeIfError')
    ..hasRequiredFields = false
  ;
  ...
  factory ScanResult({
    ...
    if (errorCodeIfError != null) {
      _result.errorCodeIfError = errorCodeIfError;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(4)
  $core.int get errorCodeIfError => $_getIZ(3);
  @$pb.TagNumber(4)
  set errorCodeIfError($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasErrorCodeIfError() => $_has(3);
  @$pb.TagNumber(4)
  void clearErrorCodeIfError() => clearField(4);
}
